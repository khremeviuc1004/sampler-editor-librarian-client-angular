...
@Component({
  ...
  templateUrl: './envelope2.component.html',
  styleUrl: './envelope2.component.scss'
})
export class Envelope2Component extends KeygroupScreenCommon implements OnInit {
  ...
  override doExtraStuff(): void {
    if (this.keygroupHeader != null) {
      const rate1 = this.keygroupHeader.envelope2.rate1;
      const level1 = this.keygroupHeader.envelope2.level1;
      const rate2 = this.keygroupHeader.envelope2.rate2;
      const level2 = this.keygroupHeader.envelope2.level2;
      const rate3 = this.keygroupHeader.envelope2.rate3;
      const level3 = this.keygroupHeader.envelope2.level3;
      const rate4 = this.keygroupHeader.envelope2.rate4;
      const level4 = this.keygroupHeader.envelope2.level4;
